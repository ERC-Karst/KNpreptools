...
def from_therion_sql_enhanced(  inputfile, 
    ...
    def extract_flags(c,type, return_type='dictionnary'):
        ...
        if type == 'shot':
            ...
            if return_type == 'dictionnary':
                return kt.list2dict(keys, values) #dict(zip(keys, values))
    ...
    dict_splays = kt.list2dict(list_splays_newi, list_splays_pos)
    ...
    dict_tree = kt.list2dict(list_tree_newi, list_tree_values)
    ...
    dict_node_flag = kt.list2dict(list_node_flag_newi, list_node_flag_values)
    ...
    dict_edge_flag = kt.list2dict(list(zip(list_from_edge_flag_newi,list_to_edge_flag_newi)), list_edge_flag_values)
